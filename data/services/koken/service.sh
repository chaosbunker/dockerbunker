...
declare -A IMAGES=( [service]="koken/koken-lemp" )
declare -A volumes=( [${SERVICE_NAME}-data-vol-1]="/usr/share/nginx/www" [${SERVICE_NAME}-db-vol-1]="/var/lib/mysql" )
declare -a networks=( )
...
configure() {
	...
	echo -e "# \e[4mKoken Settings\e[0m"
